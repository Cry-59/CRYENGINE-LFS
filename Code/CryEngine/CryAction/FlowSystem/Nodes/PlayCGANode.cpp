	...
	void GetJointInfo(SActivationInfo* pActInfo)
	{
		if (IEntity* pEntity = pActInfo->pEntity)
		{
			if (ICharacterInstance* pCharacter = pEntity->GetCharacter(0))
			{
				...
				const int32 jointID = rIDefaultSkeleton.GetJointIDByName(GetPortString(pActInfo, 0).c_str());
				if (jointID < 0)
				{
...
class CFlowNode_AGControl : public CFlowBaseNode<eNCT_Singleton>
{
public:
	enum EInputs
	{
...
class CFlowNode_AGSetInput : public CFlowBaseNode<eNCT_Singleton>
{
public:
...
class CFlowNode_AGLockInput : public CFlowBaseNode<eNCT_Singleton>
{
public:
...
class CFlowNode_AGOutput : public CFlowBaseNode<eNCT_Instanced>, public IAnimationGraphStateListener
{
public:
...
class CFlowNode_AGReset : public CFlowBaseNode<eNCT_Singleton>
{
public:
